 ...
 * @author TennKane
 */
@FeignClient(value = "tktk-service-interact", configuration = MyFeignRequestInterceptor.class)
public interface InteractClient {
     ...
     * @return 关注总数
     */
    @GetMapping("/tktk/interact/follow/num")
     ...
     * @return 粉丝总数
     */
    @GetMapping("/tktk/interact/follow/fansNum")
     ...
     * @return 是否关注
     */
    @GetMapping("/tktk/interact/follow/ifFollow")
